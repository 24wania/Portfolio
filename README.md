[index.html.html](https://github.com/user-attachments/files/23505297/index.html.html)
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <meta content="Wania Younas CV, Graphic Designer, Portfolio" name="keywords">
  <meta content="Portfolio and resume of Wania Younas, a professional Graphic Designer with 4 years of experience." name="description">
    ...
    <div class="row g-5">
      <div class="col-lg-4 sticky-lg-top vh-100">
        <div class="d-flex flex-column h-100 text-center overflow-auto shadow">
          <img class="w-100 img-fluid mb-4" src="img/Wania 12.jpg" alt="Wania Younas">
          <h1 class="text-primary mt-2">Wania Younas</h1>
          <div class="mb-4" style="height: 22px;">
            <h4 class="typed-text-output d-inline-block text-light"></h4>
            <div class="typed-text d-none">Graphic Designer, Logo Creator, Brand Identity Specialist, Creative Artist</div>
          </div>
          <div class="d-flex justify-content-center mt-auto mb-3">
            <a class="btn btn-secondary btn-square mx-1" href="https://wa.me/923261785047" target="_blank"><i class="fab fa-whatsapp"></i></a>
            <a class="btn btn-secondary btn-square mx-1" href="mailto:waniayounas15@gmail.com"><i class="fas fa-envelope"></i></a>
            <a class="btn btn-secondary btn-square mx-1" href="https://www.instagram.com/waniayounas24/" target="_blank"><i class="fab fa-instagram"></i></a>
            <a class="btn btn-secondary btn-square mx-1" href="https://www.linkedin.com/feed/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
          </div>
...
<section class="py-5 wow fadeInUp" data-wow-delay="0.1s" id="contact">
    ...
    <h4 class="mb-4">Receive messages instantly with Formspree – no PHP needed!</h4>
        ...
        <section class="wow fadeIn" data-wow-delay="0.1s">
          <div class="bg-secondary text-light text-center p-5">
            <div class="d-flex justify-content-center mb-4">
              <a class="btn btn-dark btn-square mx-1" href="https://wa.me/923261785047" target="_blank"><i class="fab fa-whatsapp"></i></a>
              <a class="btn btn-dark btn-square mx-1" href="mailto:waniayounas15@gmail.com"><i class="fas fa-envelope"></i></a>
              <a class="btn btn-dark btn-square mx-1" href="https://www.instagram.com/waniayounas24/" target="_blank"><i class="fab fa-instagram"></i></a>
              <a class="btn btn-dark btn-square mx-1" href="https://www.linkedin.com/feed/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
            </div>
            <p class="m-0">&copy; 2025 All Rights Reserved | Designed by <strong>Wania Younas</strong></p>
          </div>
        </section>
        <!-- Footer End -->
